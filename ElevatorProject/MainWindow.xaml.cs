...
namespace WorldView
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public static string path = Directory.GetCurrentDirectory() + "/../../ClassGraphics/";
        ...
        public MainWindow()
        {
            ...
            {
                WpfApplication1.MainWindow interior = new WpfApplication1.MainWindow();
                interior.Show();
                interior.Closed += (sender2, e2) =>
                interior.Dispatcher.InvokeShutdown();
            ...
            {
                ElevatorProject.ExteriorElevatorPanels exterior = new ElevatorProject.ExteriorElevatorPanels();
                exterior.Show();
                exterior.Closed += (sender2, e2) =>
                exterior.Dispatcher.InvokeShutdown();
                System.Windows.Threading.Dispatcher.Run();
            });
